#!/bin/bash
# SCBench English QA task evaluation script for PQCache
# Task: scbench_qa_eng - English question answering (strong drift)
...
echo "=========================================="
echo "SCBench English QA Task (scbench_qa_eng)"
echo "任务类型: 强漂移 - 英文问答"
echo "数据集大小: 69 samples"
echo "多轮对话: 2-4 turns"
echo "上下文类型: English texts"
echo "=========================================="

# 任务配置
TASK="scbench_qa_eng"
MODEL_NAME_OR_PATH="meta-llama/Llama-3.1-8B-Instruct"
OUTPUT_DIR="pred_scbench_qa_eng"
MAX_SEQ_LENGTH=131072
MAX_NEW_TOKENS=40  # 英文问答的标准长度（简短回答）
...
echo ""
echo "=========================================="
echo "SCBench 英文问答任务评估完成！"
echo "结果保存在: ${OUTPUT_DIR}/llama-3.1/${TASK}/pqcache_official/"
echo "=========================================="

#  nohup ./run_scbench_qa_eng.sh > scbench_run_qa_eng.log 2>&1 &
# [1] 885959