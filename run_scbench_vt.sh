#!/bin/bash
# SCBench Variable Tracing task evaluation script for PQCache
# Task: scbench_vt - Multi-hop variable tracing (multiturn KV drift)
...
echo "=========================================="
echo "SCBench Variable Tracing Task (scbench_vt)"
echo "任务类型: 多轮KV漂移 - 多跳变量追踪"
echo "数据集大小: 90 samples"
echo "多轮对话: 2-4 turns"
echo "上下文类型: Variable traces"
echo "=========================================="

# 任务配置
TASK="scbench_vt"
MODEL_NAME_OR_PATH="meta-llama/Llama-3.1-8B-Instruct"
OUTPUT_DIR="pred_scbench_vt"
MAX_SEQ_LENGTH=131072
MAX_NEW_TOKENS=30  # 变量追踪的标准长度（短回答）
