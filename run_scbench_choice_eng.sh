#!/bin/bash
# SCBench English Multiple Choice task evaluation script for PQCache
# Task: scbench_choice_eng - English multiple choice questions (strong drift)
...
echo "=========================================="
echo "SCBench English Multiple Choice Task (scbench_choice_eng)"
echo "任务类型: 强漂移 - 英文多选题"
echo "数据集大小: 58 samples"
echo "多轮对话: 2-4 turns"
echo "上下文类型: Novels"
echo "=========================================="
...
OUTPUT_DIR="pred_scbench_choice_eng"
MAX_SEQ_LENGTH=131072
MAX_NEW_TOKENS=40  # 多选题的标准长度
