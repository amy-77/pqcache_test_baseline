#!/bin/bash
# SCBench Summary task evaluation script for PQCache
# Task: scbench_summary - Document summarization (long generation decode shift)
...
echo "=========================================="
echo "SCBench Summary Task (scbench_summary)"
echo "任务类型: 长生成导致解码内注意力迁移"
echo "数据集大小: 70 samples"
echo "多轮对话: 2-4 turns"
echo "上下文类型: Long documents"
echo "=========================================="

# 任务配置
TASK="scbench_summary"
MODEL_NAME_OR_PATH="meta-llama/Llama-3.1-8B-Instruct"
OUTPUT_DIR="pred_scbench_summary"
MAX_SEQ_LENGTH=131072
MAX_NEW_TOKENS=200  # 摘要任务的标准长度
...
echo ""
echo "=========================================="
echo "SCBench 摘要任务评估完成！"
echo "结果保存在: ${OUTPUT_DIR}/llama-3.1/${TASK}/pqcache_official/"
echo "=========================================="



#  nohup ./run_scbench_summary.sh > scbench_run_summary.log 2>&1 &
# [1] 432019