#!/bin/bash
# SCBench Many-shot ICL task evaluation script for PQCache
# Task: scbench_many_shot - In-context learning with hundreds of examples
...
echo "=========================================="
echo "SCBench Many-shot ICL Task (scbench_many_shot)"
echo "任务类型: 全局信息处理 - 多样本上下文学习"
echo "数据集大小: 54 samples"
echo "多轮对话: 2-4 turns"
echo "上下文类型: ICL examples"
echo "=========================================="

# 任务配置
TASK="scbench_many_shot"
MODEL_NAME_OR_PATH="meta-llama/Llama-3.1-8B-Instruct"
OUTPUT_DIR="pred_scbench_many_shot"
MAX_SEQ_LENGTH=131072
MAX_NEW_TOKENS=10  # 多样本学习的标准长度（短回答）
