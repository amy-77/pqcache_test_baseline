#!/bin/bash
# SCBench Prefix-Suffix task evaluation script for PQCache
# Task: scbench_prefix_suffix - String pattern matching (multiturn KV drift)
...
echo "=========================================="
echo "SCBench Prefix-Suffix Task (scbench_prefix_suffix)"
echo "任务类型: 多轮KV漂移 - 前后缀匹配"
echo "数据集大小: 100 samples"
echo "多轮对话: 2-4 turns"
echo "上下文类型: Text patterns"
echo "=========================================="

# 任务配置
TASK="scbench_prefix_suffix"
MODEL_NAME_OR_PATH="meta-llama/Llama-3.1-8B-Instruct"
OUTPUT_DIR="pred_scbench_prefix_suffix"
MAX_SEQ_LENGTH=131072
MAX_NEW_TOKENS=150  # 前后缀匹配的标准长度
