#!/bin/bash
# SCBench KV retrieval task evaluation script for PQCache
# Task: scbench_kv - Key-value lookup in large JSON objects
...
echo "=========================================="
echo "SCBench KV Retrieval Task (scbench_kv)"
echo "任务类型: 字符串检索 - 键值查找"  
echo "数据集大小: 100 samples"
echo "多轮对话: 2-4 turns"
echo "上下文类型: JSON objects"
echo "=========================================="

# 任务配置
TASK="scbench_kv"
MODEL_NAME_OR_PATH="meta-llama/Llama-3.1-8B-Instruct"
OUTPUT_DIR="pred_scbench_kv"
MAX_SEQ_LENGTH=131072
MAX_NEW_TOKENS=150  # KV检索任务的标准长度
