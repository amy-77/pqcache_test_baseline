#!/bin/bash
# SCBench Math Find task evaluation script for PQCache
# Task: scbench_mf - Mathematical finding tasks (strong drift)
...
echo "=========================================="
echo "SCBench Math Find Task (scbench_mf)"
echo "任务类型: 强漂移 - 数学查找"
echo "数据集大小: 100 samples"
echo "多轮对话: 2-4 turns"
echo "上下文类型: Numerical arrays"
echo "=========================================="

# 任务配置
TASK="scbench_mf"
MODEL_NAME_OR_PATH="meta-llama/Llama-3.1-8B-Instruct"
OUTPUT_DIR="pred_scbench_mf"
MAX_SEQ_LENGTH=131072
MAX_NEW_TOKENS=5  # 数学查找任务只需要极短回答（数字）
...
echo ""
echo "=========================================="
echo "SCBench 数学查找任务评估完成！"
echo "结果保存在: ${OUTPUT_DIR}/llama-3.1/${TASK}/pqcache_official/"
echo "=========================================="

#  nohup ./run_scbench_mf.sh > scbench_run_mf.log 2>&1 &
# 1401805